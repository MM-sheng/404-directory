...
describe("HTTP API", () => {
  ...
  it("renders a no-store evidence dashboard without raw identity data", async () => {
    ...
    expect(dashboard.body).toContain("Verified external Agents")
    expect(dashboard.body).toContain("Verified independent operators")
    expect(dashboard.body).toContain("Prediction-market preflight")
    expect(dashboard.body).toContain("7-day verified retention")
